...
dojo.provide("xwt.widget.tests.table.store.SampleExtendedIFWS");

dojo.require("dojo.data.ItemFileWriteStore");
dojo.require("xwt.widget.table.Filter");

dojo.declare("xwt.widget.tests.table.store.SampleExtendedIFWS", [dojo.data.ItemFileWriteStore], {
	...
	newItem: function(data, parentInfo){
		var idAttribute = this.getIdentityAttributes()[0];
		data = data || {};
		if(!(idAttribute in data)){
			data[idAttribute] = new Date().getTime();
		}
