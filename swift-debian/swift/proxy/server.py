...
class Controller(object):
    ...
    def _make_request(self, nodes, part, method, path, headers, query):
        ##################################################
        ## For debug
        self.app.logger.error("[Xiaomeng] headers = %s" % str(headers))
        self.app.logger.error("[Xiaomeng] method = %s" % method)
        self.app.logger.error("[Xiaomeng] path = %s" % path)
        self.app.logger.error("[Xiaomeng] query = %s" % query)
        self.app.logger.error("[Xiaomeng] part = %d" % part)
        self.app.logger.error("[Xiaomeng] nodes = %s" % str(nodes))
